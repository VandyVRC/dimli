...
// Iterate through each image record
{
	...
	$sql = "SELECT * FROM dimli.technique 
				WHERE related_images = '{$imageId}' ";
	...
	$sql = "SELECT * FROM dimli.work_type 
				WHERE related_images = '{$imageId}' ";
	...
	$sql = "SELECT * FROM dimli.material 
				WHERE related_images = '{$imageId}' ";
	...
	$sql = "SELECT * FROM dimli.measurements 
				WHERE related_works = '{$workId}' ";
	...
	$sql = "SELECT * FROM dimli.location 
				WHERE related_images = '{$imageId}' ";
	...
	$sql = "SELECT * FROM dimli.style_period 
				WHERE related_images = '{$imageId}' ";
	...
	$sql = "SELECT description FROM dimli.work WHERE id = '{$workId}' ";
	...
	$sql = "SELECT * FROM dimli.lecture_tag 
	...
	$sql = "SELECT order_id FROM dimli.image 
				WHERE id = '{$imageId}' ";
	...
	$csvArray[$i] = array(
		...
		'styleperiodALT' => $super_culture_string,
