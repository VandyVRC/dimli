...
<!-- Favicon -->
<link href="<?php echo $webroot; ?>/_assets/_images/favicon.png" rel="icon" type="image/png">
		...
		<ul id="header_userInfo">
			...
			<li>
				...
				<?php if (logged_in()) { ?>
					...
					<a href="<?php echo $webroot; ?>/logout.php">log out</a>

				<?php } else { ?>

					<a href="<?php echo $webroot; ?>/login.php">log in</a>
...
<div id="control_panel_wide">
	...
	<div id="control_panel">
		...
		<?php if (logged_in()) {
			...
			include('<?php echo $webroot; ?>/_php/_lantern/lantern_control_panel.php');
